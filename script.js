...
// Pages without the work-tabs section (e.g. reviews.html) share this header
// nav, so skip wiring up tab behavior there and let those links navigate
// normally to index.html.
